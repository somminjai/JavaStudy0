...
public class Conditional {
    ...
    public static void main(String[] args) {
        ...
        // if문에 소괄호 안 조건이 true면 중괄호 내부 코드 실행
        ...
        // 삼항연사자는 조건에 따른 변수 값 변화시 사용하면 좋다.
        ...
        // isPowerOn은 전원이 켜지면 true, 켜져있으면 false
        boolean isPowerOn = false;

        // 전원버튼 누르기
        if(isPowerOn == false) { // isPowerOn은 true/false 두가지 케이스 뿐
        ...
        System.out.println(grade); // B가 나옴.
        ...
        if(month == 0){
            ...
            System.out.println("자바FX 프로젝트");
        }else if(month == 3){
            System.out.println("JSP-스프링, SPA 배우는중");
        }else if(month == 4){
