...
public class StringMain{
        ...
        public static void main(String[] args) {
            ...
            // contains는 괄호 안 문자열을 포함하면 true, 포함하지 않으면 false로 리턴
            ...
            System.out.println(fruits.replace("charry", "banana"));
                    System.out.println(fruits);

            //원본에 적용하기
            fruits = fruits.replace("charry","banana");
            System.out.println(fruits);
